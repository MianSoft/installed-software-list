...
4. 图标可以用 [Axialis IconWorkshop](https://www.axialis.com/iconworkshop/) 来提取, 我这同统一改为 48px
...
- <img src=".\public\KOOK.ico" width="24px" height="24px"> [KOOK](https://kookapp.cn) - 国际老大哥在国内的大儿子
- <img src=".\public\DoDo.ico" width="24px" height="24px"> [DoDo](https://imdodo.com) - 国际老大哥在国内的二儿子
...
- <img src=".\public\Firefox Nightly.ico" width="24px" height="24px"> [Firefox Nightly](https://mozilla.org/firefox/channel/desktop) - 蓝紫色狐狸精 (Nightly限定)
...
- <img src=".\public\NanaZip.ico" width="24px" height="24px"> [NanaZip](https://github.com/M2Team/NanaZip) - 现代化界面的7-Zip开源衍生软件, 3.0 会有新界面可以放弃 Bandizip 了
- <img src=".\public\7-Zip.ico" width="24px" height="24px"> [7-Zip](https://sparanoid.com/lab/7z) - 比 WinRAR 好用不知道多少
- <img src=".\public\Bandizip.ico" width="24px" height="24px"> [Bandizip](https://bandisoft.com/bandizip) - 应该是比 7-Zip 更主流的压缩软件?
...
- <img src=".\public\PikPak.ico" width="24px" height="24px"> [PikPak](https://mypikpak.com/desktop-app) - 我个人用来下磁链文件, 速度很喜人
...
- <img src=".\public\OBS Studio.ico" width="24px" height="24px"> [OBS Studio](https://obsproject.com) - Open Broadcaster Software
- <img src=".\public\Move Transition.ico" width="24px" height="24px"> [Move Transition](https://obsproject.com/forum/resources/move.913) - OBS 插件 提供了无缝转场效果
- <img src=".\" width="24px" height="24px"> [StreamFX (for OBS Studio) version 0.12.0.393]() -
- <img src=".\" width="24px" height="24px"> [StreamUP version 1.3.2]() -
- <img src=".\" width="24px" height="24px"> [Waveform]() -
- <img src=".\" width="24px" height="24px"> [advanced-scene-switcher]() -
- <img src=".\" width="24px" height="24px"> [obs-ndi]() -
- <img src=".\" width="24px" height="24px"> [Source Switcher]() -
- <img src=".\" width="24px" height="24px"> [Spout 2 OBS Plugin]() -
- <img src=".\public\NDI.ico" width="24px" height="24px"> [NDI 5](https://ndi.video/tools) - 特别吃带宽的源
...
- <img src=".\public\WebM for Premiere.png" width="82px" height="24px"> [WebM for Premiere](https://fnordware.com/WebM) - 导出 WebM 格式文件
- <img src=".\public\Boris FX Sapphire.ico" width="24px" height="24px"> [Boris FX Sapphire Plug-ins for After Effects](https://borisfx.com/products/sapphire) - Boris 特效
...
- <img src=".\public\FontCreator.ico" width="24px" height="24px"> [FontCreator](https://high-logic.com/font-editor/fontcreator) - 别用盗版软件扩字了, 律师函迟早寄你家门口
...
- <img src=".\public\MSPCManager.ico" width="24px" height="24px"> [微软电脑管家 (Beta)](https://pcmanager.microsoft.com/) - 感觉比较可有可无了
- <img src=".\public\Huorong.ico" width="24px" height="24px"> [火绒安全软件](https://huorong.cn/) - 同上

### 系统辅助

- <img src=".\public\Clash Verge.ico" width="24px" height="24px"> [Clash Verge](https://github.com/clash-verge-rev/clash-verge-rev) - Clash Verge 的开源延续
...
- <img src=".\public\Files.ico" width="24px" height="24px"> [Files](https://files.community/) - GitHub 上拥有30k+ star 的文件管理器
...
- <img src=".\public\Apple iTunes.ico" width="24px" height="24px"> [Apple iTunes](https://support.apple.com/downloads/itunes) - 完全不听歌所以放驱动类里是吧
...
- <img src=".\public\Steam.ico" width="24px" height="24px"> [Steam](https://store.steampowered.com/about) - G胖什么时候能数3我求你了😭
...
- <img src=".\public\CheatEngine.ico" width="24px" height="24px"> [Cheat Engine](https://cheatengine.org) - 玩在线游戏开挂死妈妈
...
- <img src=".\public\Crosshair X.ico" width="24px" height="24px"> [Crosshair X Extension](https://centerpointgaming.com) - 外置准心 (没下面的好用)
...
- <img src=".\public\Techmino Galaxy.ico" width="24px" height="24px"> [Techmino Galaxy](https://github.com/26F-Studio/Techmino_Galaxy) - 铁盖好玩, 但是Z酱更好玩
...
- <img src=".\" width="24px" height="24px"> [英特尔(R) 网络连接] -

- <img src=".\" width="24px" height="24px"> [Intel(R) Chipset Device Software] -

- <img src=".\" width="24px" height="24px"> [Intel(R) Computing Improvement Program] -

- <img src=".\" width="24px" height="24px"> [Intel(R) Extreme Tuning Utility] -

- <img src=".\" width="24px" height="24px"> [Intel(R) LMS] -

- <img src=".\" width="24px" height="24px"> [Intel(R) Management Engine Components] -

- <img src=".\" width="24px" height="24px"> [Intel(R) Management Engine Components] -

- <img src=".\" width="24px" height="24px"> [Intel(R) Management Engine Driver] -

- <img src=".\" width="24px" height="24px"> [Intel(R) Network Connections 27.7.0.2] -

- <img src=".\" width="24px" height="24px"> [Intel(R) Serial IO] -
- <img src=".\" width="24px" height="24px"> [Intel(R) Chipset Device Software] -

- <img src=".\" width="24px" height="24px"> [Intel® Hardware Accelerated Execution Manager] -
...
- <img src=".\" width="24px" height="24px"> [StartIsBack++]() -
...
- <img src=".\" width="24px" height="24px"> [seam] - 
